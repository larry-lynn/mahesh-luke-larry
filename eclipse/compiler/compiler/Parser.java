...
public class Parser {
    ...
    public void Type(){
    	// Can be 3 types "Integer", "Float", "Boolean"
        switch(lookahead.token_name){
	        case MP_IDENTIFIER:
	        	//check to see if the ID is an Integer
	        	if(lookahead.lexeme.equals("Integer"))
	        	{
	        		//return("Integer");
	        	}
	        	//check to see if the ID is a Float
	        	else if(lookahead.lexeme.equals("Float"))
	        	{
	        		//return("Float");
	        	}
	        	//check to see if we have a boolean
	        	else if(lookahead.lexeme.equals("Boolean"))
	        	{
	        		//return("Boolean");
	        	}
	        	else
    ...
    public void ProcedureHeading(){
    	// 17. "procedure" <ProcedureIdentifer> <OptionalFormalParamterList>
        switch(lookahead.token_name){
	        case MP_IDENTIFIER:
	        	match(TokenType.MP_PROCEDURE);
	        	ProcedureIdentifier();
	        	// OptionalFormalFaramterList();
	        	break;
	        default:
		        // parsing error
		        System.out.println("Parsing error at: " + Thread.currentThread().getStackTrace()[2].getLineNumber());
    ...
    public void FunctionHeading(){
    	// 18. "function" <FunctionIdentifer> <OptionalFormalParamterList>
        switch(lookahead.token_name){
	        case MP_IDENTIFIER:
	        	match(TokenType.MP_FUNCTION);
	        	FunctionIdentifier();
	        	// OptionalFormalParamterList():
	        	break;
	        default:
		        // parsing error
		        //System.out.println("Parsing error at: " + Thread.currentThread().getStackTrace()[2].getLineNumber());
